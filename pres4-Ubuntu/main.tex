...
%\begin{frame}{Another few Commands That you Could use in Terminal.}
%\begin{itemize}
%\item Another few commands for terminal is to help see if one code like python is installed in the Ubuntu that you are using.
%\item The commands to see if there is python in Ubuntu is down below this line.
%
%\\
%~\\
%\item python -v
%\item python -V
%\item python3 -V
%Those are ways that you can type in terminal that you could use to find if you have any of those pythons.
%\end{itemize}
%\end{frame}
